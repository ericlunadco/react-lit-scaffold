...
.usa-checkbox__input:checked[aria-disabled="true"]
  ...
  background-image: url("https://intellibridge.github.io/conduit-assets/img/uswds/img/correct8.svg"),
...
@media (forced-colors: active) {
  ...
  .usa-checkbox__input:checked[aria-disabled="true"]
    + [class*="__label"]::before {
    background-image: url("https://intellibridge.github.io/conduit-assets/img/uswds/img/correct8-alt.svg"),
      -webkit-gradient(linear, left top, left bottom, from(transparent), to(transparent));
    background-image: url("https://intellibridge.github.io/conduit-assets/img/uswds/img/correct8-alt.svg"),
      linear-gradient(transparent, transparent);
    background-repeat: no-repeat;
