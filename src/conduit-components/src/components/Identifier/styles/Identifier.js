...
.usa-identifier--small {
  font-size: 0.75rem;
  padding: 0.125rem 0.375rem;
}

.usa-identifier--large {
  font-size: 1rem;
  padding: 0.375rem 0.75rem;
}

.usa-identifier--primary {
  background-color: #d9e8f6;
  color: #162e51;
}

.usa-identifier--secondary {
  background-color: #f3e1e4;
  color: #8b0a03;
}

.usa-identifier--accent {
...
.usa-identifier--success {
  background-color: #ecf3ec;
  color: #216e1f;
}

.usa-identifier--warning {
  background-color: #faf3d1;
  color: #936f38;
}

.usa-identifier--error {
  background-color: #f4e3db;
  color: #6f3331;
}

.usa-identifier__prefix,
.usa-identifier__suffix {
  color: inherit;
  opacity: 0.8;
}
...
.usa-identifier__remove:focus,
.usa-identifier__remove:hover {
  opacity: 1;
}

.usa-identifier__remove .usa-icon {
  width: 0.75rem;
  height: 0.75rem;
}`;