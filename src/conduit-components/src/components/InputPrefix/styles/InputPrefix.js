...
.usa-input-prefix-suffix .usa-input {
  -webkit-box-flex: 1;
  -ms-flex: 1;
  flex: 1;
  margin-top: 0;
...
.usa-input-prefix-suffix .usa-input:not(:first-child) {
  border-top-left-radius: 0;
  border-bottom-left-radius: 0;
}

.usa-input-prefix-suffix .usa-input:not(:last-child) {
...
.usa-form-group--error .usa-input-prefix,
.usa-form-group--error .usa-input-suffix {
  border-color: #d54309;
}

.usa-input-prefix + .usa-input[disabled],
.usa-input[disabled] + .usa-input-suffix {
