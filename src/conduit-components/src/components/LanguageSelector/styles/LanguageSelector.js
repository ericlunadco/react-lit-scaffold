...
.usa-language-selector__trigger {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.usa-language-selector__trigger:hover:not([disabled]) {
  background-color: #f0f0f0;
}

.usa-language-selector__trigger[disabled] {
  cursor: not-allowed;
  opacity: 0.5;
}

.usa-language-selector__trigger .usa-icon {
  margin-left: auto;
  width: 1.25rem;
  height: 1.25rem;
}

.usa-language-selector__flag {
  width: 1.25rem;
  height: 1.25rem;
  -o-object-fit: cover;
  object-fit: cover;
...
.usa-language-selector__list.is-visible {
  visibility: visible;
  opacity: 1;
...
.usa-language-selector__item.is-selected {
  background-color: #d9e8f6;
}

.usa-language-selector__item-button {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
  -webkit-box-align: center;
...
.usa-language-selector__item-button:hover:not([disabled]) {
  background-color: #f0f0f0;
}

.usa-language-selector__item-button[disabled] {
  cursor: not-allowed;
  opacity: 0.5;
}

.usa-language-selector__item-button .usa-icon {
  margin-left: auto;
  width: 1rem;
  height: 1rem;
  color: #005ea2;
...
.usa-language-selector__item-label {
  -webkit-box-flex: 1;
  -ms-flex: 1;
  flex: 1;
  display: -webkit-box;
